...
// Version where it only checks the last word/space you type and then leaves mistakes behind:

// if (wordList.includes(wordsWritten[i]) || wordsWritten[i] === ' ' || wordsWritten[i] === '') {
//   setSpellingError('')
// } else {
//   setSpellingError(`The word "${wordsWritten[i]}" is spelled wrong or is not a word in BASIC English.`)
// }
...
// Version where it remembers past mistakes but it doesn't clear if you fix them:
